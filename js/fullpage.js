...
class LoadModelDemo {
  ...
  _Initialize() {
    ...
    this._threejs.setSize(window.innerWidth, window.innerWidth); //window.innerWidth, window.innerHeight
  ...
  _OnWindowResize() {
    ...
    this._threejs.setSize(window.innerWidth, window.innerWidth);
  }
